...
{
  bytearray_t elems;
  array_t<idx_t> int_from_ext; // maps external indices to internal indices of idx_hashset_t.elems.
  array_t<idx_t> ext_from_int; // maps internal indices of idx_hashset_t.elems to external indices.
